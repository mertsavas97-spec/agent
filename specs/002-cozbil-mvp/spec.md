...
Ücretsiz kullanıcı günde sınırlı soru hakkına sahiptir (varsayılan **5**/gün). Hak bitince paywall (moodboard Premium): sınırsız soru, reklamsız, kişisel AI analizi vb.; CTA “Hemen Başla”; aylık vitrin **49 TL**.
...
- Ücretsiz günlük hak **5**; aylık plan vitrin **49 TL**.
