...
class VideoParams(BaseModel):
    ...
    # pexels = classic fullscreen B-roll; brainrot = muted BG loop + PiP overlays
    render_mode: Optional[Literal["pexels", "brainrot"]] = "pexels"
    brainrot_bg_pack: Optional[str] = "satisfaction"
    brainrot_bg_source: Optional[str] = "pexels"
    brainrot_overlay_count: Optional[int] = 5
    brainrot_overlay_max_width_pct: Optional[float] = 0.64
    brainrot_overlay_max_height_pct: Optional[float] = 0.42
    brainrot_overlay_max_coverage: Optional[float] = 0.55
    brainrot_overlay_position: Optional[str] = "center_upper"
    brainrot_overlay_margin_top_pct: Optional[float] = 0.12
    brainrot_mute_bg: Optional[bool] = True
