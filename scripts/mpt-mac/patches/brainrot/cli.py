...
""",
    ...
    material_group.add_argument(
        "--render-mode",
        default=None,
        choices=["pexels", "brainrot"],
        help="pexels = classic B-roll cutaways; brainrot = Pexels satisfaction BG loop + PiP topic images",
    )
    material_group.add_argument(
        "--brainrot-bg-pack",
        default=None,
        choices=["satisfaction", "abstract", "nature_motion", "mechanica"],
        help="brainrot background query pack (Pexels, free)",
    )
    material_group.add_argument(
        "--brainrot-overlay-count",
        type=int,
        default=None,
        help="number of timed PiP topic images in brainrot mode",
    )
    material_group.add_argument(
        "--video-materials",
        default="",
